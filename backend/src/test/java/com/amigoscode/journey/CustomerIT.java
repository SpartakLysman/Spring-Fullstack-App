...
//    @Autowired
//    private CustomerController;  <--*  NEVER DO THIS, SEND A REQUEST DIRECTLY TO THE API BUT NOT INVOKE THE CONTROLLER
    ...
    void canDeleteCustomer() {
        ...
        CustomerRegistrationRequest request2 =
                new CustomerRegistrationRequest(name, email + ".uk", "password", age, gender);
    ...
    void canUpdateCustomer() {
        ...
        CustomerDTO expected =
                new CustomerDTO(id, newName, email, gender, age, List.of("ROLE_USER"), email, null);
